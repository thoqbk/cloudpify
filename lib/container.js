...
function Container() {
    ...
    nameNServiceMap["$buildFx"] = self.build;
    nameNServiceMap["$invokeFx"] = self.invoke;
    nameNServiceMap["$registerFx"] = self.register;
    nameNServiceMap["$registerByClassFx"] = self.registerByClass;
    nameNServiceMap["$resolveFx"] = self.resolve;
}