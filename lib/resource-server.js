...
module.exports = function ($config, http, $invokeFx) {
    ...
    return new Promise(function (resolve, reject) {
        Promise.resolve($invokeFx(require("./base-start/resources.js"), null, resolveParameterFx))
                .then(function () {
                    return Promise.resolve($invokeFx(require("../start/resources.js"), null, resolveParameterFx));
                })
                .then(function () {
